...
<h3 style="margin: 5px 0px;">DEPARTMENT OF SCIENCE AND TECHNOLOGY</h3>
<p style="margin-top: 5px;">Regional Office X</p>
</div>
...
Office: <?=$officename['name']?></p>  <br>
    <h5 style="margin-top: 2px; margin-bottom: 5px;">Part I. Respondents Demographic Profile</h5>
...
<tr>
    ...
    <h5 style="margin-bottom: 5px;">Part II. Results of Citizen's Charter Questions</h5>
    ...
    <h5 style="margin-bottom: 5px;">Part III. Score Per Service</h5>
    <table class="table table-bordered table-full">
        <thead>
            <tr class="text-center">
                <th>Services</th>
    ...
    <h5 style="margin-bottom: 5px;">Part IV. Results of Service Quality Dimensions</h5>
    ...
    <h5 style="margin-bottom: 5px;">Part V. Repondents Demographic Profile</h5>
    <p style="margin-top: 5px;"><?=$officename['name']?> Overall Customer Satisfaction  Rating for
    ...
    ?>
    <?=$params['year']?> is <strong><u><?=$sqd0_percentage?>%</u></strong></p>
    ...
    <h5 style="margin-bottom: 5px;">Annex. Comments or suggestions from the clients or customers.</h5>
    <div class="comments-container">
        <?php foreach ($comments as $commentsRow) { ?>
            <h6 style="margin: auto 5px;"><?php echo $commentsRow['name'] . ($commentsRow['name'] && $commentsRow['unit'] ? " - " : '') . $commentsRow['unit']; ?></h6>
            <ul>
