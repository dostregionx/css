...
class ReportsModel extends Model
{
    ...
    public function gen_sqd($params) {
        ...
        $builder->select('
            ...
            COUNT(CASE WHEN SQD0 = 0 THEN 0 END) AS 0_SQD0,
            ...
            COUNT(CASE WHEN SQD1 = 0 THEN 0 END) AS 0_SQD1,
            ...
            COUNT(CASE WHEN SQD2 = 0 THEN 0 END) AS 0_SQD2,
            ...
            COUNT(CASE WHEN SQD3 = 0 THEN 0 END) AS 0_SQD3,
            ...
            COUNT(CASE WHEN SQD4 = 0 THEN 0 END) AS 0_SQD4,
            ...
            COUNT(CASE WHEN SQD7 = 0 THEN 0 END) AS 0_SQD7,
            ...
            COUNT(CASE WHEN SQD8 = 0 THEN 0 END) AS 0_SQD8,
            ...
            COUNT(CASE WHEN SQD9 = 0 THEN 0 END) AS 0_SQD9,
            ...
            COUNT(CASE WHEN SQD10 = 0 THEN 0 END) AS 0_SQD10,
